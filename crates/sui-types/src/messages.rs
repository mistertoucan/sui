    ...
    fn new_system_transaction(system_transaction: SingleTransactionKind) -> Self {
        system_transaction
            ...
            .pipe(|data| SenderSignedData {
                ...
                tx_signature: GenericSignature::Signature(Ed25519SuiSignature::from_bytes(&[0; Ed25519SuiSignature::LENGTH])
                    .unwrap()
                    .into()),
            })
